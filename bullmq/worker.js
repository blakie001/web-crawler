...
const logUrls = (domain, urls) =>{
    ...
    fs.appendFileSync("crawled_urls.json", JSON.stringify(logData, null, 2) + "/n");
}
...
const worker = new Worker(
    ...
    async(job) =>{
        ...
        try {
            ...
            console.log(`Crawled ${domain} and fetched ${productLinks.length} url's`);
    ...
    },
    {
        ...
        concurrency: process.env.PARALLEL_PROCESSES || 10,
